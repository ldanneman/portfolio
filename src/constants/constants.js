export const projects = [
  {
    ...
    image: "/images/bermad-desktop.png",
    tags: ["React Native", "React Native Web", "GraphQL"],
    source: "https://cloud.bermad.io/",
    visit: "/",
    id: 0,
  },
  {
  ...
  },
  {
    ...
    image: "/images/shift-hackathon.png",
    tags: ["React", "NodeJS", "Express"],
    source: "https://healthcare-schedule-app.netlify.app/",
    visit: "https://github.com/ldanneman/schedule-app",
    id: 3,
  },
];

export const TimeLineData = [
  { year: 2019, text: "final year working as a financial manager" },
  { year: 2020, text: "Started my programming journey" },
  { year: 2021, text: "worked at a fast paced startup" },
  {
    year: 2022,
    text: "worked as a developer at a large international company",
  },
];
